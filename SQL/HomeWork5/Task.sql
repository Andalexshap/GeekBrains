...
INSERT INTO users (users.id, users.firstname, users.lastname, users.email) VALUES
...
INSERT INTO messages  (messages.from_user_id, messages.to_user_id, messages.body, messages.created_at) VALUES
...
INSERT INTO friend_requests (friend_requests.initiator_user_id, friend_requests.target_user_id, friend_requests.`status`, friend_requests.requested_at, friend_requests.updated_at)
VALUES
...
INSERT INTO `communities` (communities.name)
...
INSERT INTO users_communities (users_communities.user_id, users_communities.community_id)
VALUES
(1, 1), (1, 2), (1, 3),
(2, 1), (2, 2),
...
INSERT INTO media_types (media_types.name_type)
...
INSERT INTO media (media.media_type_id, media.user_id, media.filename, media.body) VALUES
...
INSERT INTO likes (likes.user_id, likes.media_id) VALUES
...
INSERT INTO `profiles` (profiles.user_id, profiles.gender, profiles.birthday, profiles.photo_id, profiles.hometown) VALUES
